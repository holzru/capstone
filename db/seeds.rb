...
500.times do
  Event.create(creator_id: (1..39).to_a.sample, title: Faker::StarWars.specie, group_id: (1..100).to_a.sample, description: Faker::StarWars.quote, location: "#{Faker::Address.street_address}, #{Faker::Address.city}", category: Faker::StarWars.planet, pic_url: pics.sample, date: Faker::Time.between(10.days.ago, Date.today, :all))
end
